(() => { 
    var i = { 
        ...
        observe() { 
            let s = ['[class*=" intersect:"]', '[class*=":intersect:"]', '[class^="intersect:"]', '[class="intersect"]', '[class*=" intersect "]', '[class^="intersect "]', '[class$=" intersect"]']; 
        ...
        getThreshold(s) { 
            return s.classList.contains("intersect-full") ? .99 : s.classList.contains("intersect-half") ? .5 : 0 
        } 
    }, 
    r = i; 
    r.start(); 
