...
import { Consultation } from '../Images.jsx';
...
const AboutSection = () => {
    ...
    return (
        <section className="min-h-svh lg:bg-gray-100 overflow-clip flex justify-center items-center" id='aboutSection'>
            <div className="min-h-[80svh] w-full my-2 flex items-center relative translate-x-5 intersect intersect:translate-x-0 transition duration-500">
                ...
                <div className="flex justify-center lg:justify-start lg:items-end mx-4 lg:mx-12 lg:w-[75%] z-50 lg:-translate-x-52 intersect intersect-half intersect:translate-x-0 transition duration-500">
                    <div className="h-auto md:p-4 w-full lg:w-[inherit] shadow-2xl backdrop-blur-md bg-white/30 rounded-md animate-fade-right duration-200">
                        <div className="flex flex-col gap-y-10 lg:gap-y-10 justify-center h-full p-4 md:px-10">
                            <span className="text-left font-semibold heroHeading">
                            ...
                            <Link to="/" className="text-2xl gap-x-5 font-medium text-slate-500 flex flex-row items-center md:items-baseline w-fit group">
                                <span>Read More</span>
